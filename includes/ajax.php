...
add_action('wp_enqueue_scripts', function () {
    ...
    wp_enqueue_script('mvp-click-tracker', plugin_dir_url(__FILE__) . '../assets/click-tracker.js', ['jquery'], '2.0.1', true);
    wp_localize_script('mvp-click-tracker', 'mvp_ajax', [
        'ajax_url' => admin_url('admin-ajax.php'),
        'nonce' => wp_create_nonce('mvp_click_nonce')
    ]);
    wp_enqueue_script('mvp-link-tracker', plugin_dir_url(__FILE__) . '../assets/link-tracker.js', [], '2.0.1', true);
...
function mvp_log_click() {
    ...
    // phpcs:ignore WordPress.DB.DirectDatabaseQuery.DirectQuery -- Safe usage, validated table and input.
